namespace TeisterMask
{
    ...
    public class StartUp
    {
        ...
        private static void ImportEntities(TeisterMaskContext context,string baseDir, string exportDir)
        {
            ...
            PrintAndExportEntityToFile(projects, exportDir + "Actual Result - ImportProjects.txt"); //Actual Result - // removed
        ...
        private static void ExportEntities(TeisterMaskContext context, string exportDir)
        {
            ...
            File.WriteAllText(exportDir + "Actual Result - ExportMostBusiestEmployees.json", exportTopMovies); //Actual Result - 
        }
